      ...
      <div className="flex sm:gap-4 flex-col sm:flex-row mt-6 justify-between items-center">
        <div>
          ...
          <p className="text-white">
            ...
            hard words, numbers and fails if your accuracy if below 95% after 5
            words typed but only total of 200 words
          </p>
        </div>
      ...
      <div className="flex sm:gap-4 flex-col sm:flex-row mt-6 justify-between items-center">
        <div>
          ...
          <p className="text-white">
            ...
            to Burmese if you want to but is&apos;s not available for all pages.
          </p>
        </div>
        <div className="flex items-center gap-4 mt-6 sm:mt-0">
          <button
